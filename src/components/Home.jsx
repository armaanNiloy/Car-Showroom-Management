...
const Home = () => {
    ...
    return (
        <div>
            ...
            <section className="grid grid-cols-2 mx-20 gap-5 mb-10">
                <div className="p-10 text-center bg-white rounded-md">
                    ...
                    <div className="h-auto">
                        <h3 className="text-3xl font-bold text-black mt-2">Find Your Fit</h3>
                        <p className="mt-2">Not sure what you want? Answer a few questions to find what fits you best.</p>
                        <button className="px-8 py-3 rounded-full bg-black text-white text-2xl font-semibold mt-2">Start quiz</button>
                    </div>
                </div>
                <div className="p-20 text-center bg-white rounded-md">
                    <div className="flex justify-center mt-2 h-1/2">
                    ...
                    <div className="h-auto">
                        <h3 className="text-3xl font-bold text-black mt-2">Shop by budget</h3>
                        <p className="mt-2">Save time and narrow down cars that fit your monthly payment and price point.</p>
                        <button className="px-8 py-3 rounded-full bg-black text-white text-2xl font-semibold mt-2">See your buying power</button>
                    </div>
                </div>
                <div className="p-20 text-center bg-white rounded-md">
                    <div className="flex justify-center mt-2 h-1/2">
                    ...
                    <div className="h-auto">
                        <h3 className="text-3xl font-bold text-black mt-2">Build and price</h3>
                        <p className="mt-2">Choose the make, model, trim, and options you want.</p>
                        <button className="px-8 py-3 rounded-full bg-black text-white text-2xl font-semibold mt-2">Build your car</button>
                    </div>
                </div>
                <div className="p-20 text-center bg-white rounded-md">
                    <div className="flex justify-center mt-2 h-1/2">
                    ...
                    <div className="h-auto">
                        <h3 className="text-3xl font-bold text-black mt-2">Sell and trade</h3>
                        <p className="mt-2">Get an offer in minutes, then cash out or trade in.</p>
                        <button className="px-8 py-3 rounded-full bg-black text-white text-2xl font-semibold mt-2">Learn more</button>
                    </div>
                </div>
